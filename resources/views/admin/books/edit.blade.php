    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <span class="mr-3"><a href="{{ route('books.index') }}" cl><i
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            @if ($book->is_second_hand)
                                <label><b>Condition: Second Hand</b></label>
                                <br>
                                <label><b>Selling Req Id: {{ $book->selling_requests->request_id }}</b></label>
                            @else
                                <label><b>Condition: New</b></label>
                            @endif
                        </div>
                        <div class="form-group">
                            {!! Form::label('title') !!}
                        ...
                        <div class="form-group">
                            {!! Form::label('quantity') !!}
                            @if ($book->is_second_hand)
                                {!! Form::text('quantity', null, ['class' => 'form-control ' . ($errors->has('quantity') ? 'is-invalid' : ''), 'readonly' => true]) !!}
                            @else
